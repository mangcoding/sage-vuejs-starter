...
function get_default_settings() {
    $settings = [
        ...
        "asset_image"        => asset('images')->uri(),
        'nonce'              => wp_create_nonce('wp_rest'),
    ];
    return $settings;
}
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('Open+Sans','//fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600;1,700&display=swap', array(), null);
    wp_enqueue_style('Nanum+Gothic','//fonts.googleapis.com/css2?family=Nanum+Gothic:wght@400;700;800&display=swap', array(), null);
